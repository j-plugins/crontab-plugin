...
public class CrontabVariableValueImpl extends ASTWrapperPsiElement implements CrontabVariableValue {

  public CrontabVariableValueImpl(@NotNull ASTNode node) {
    super(node);
  }
