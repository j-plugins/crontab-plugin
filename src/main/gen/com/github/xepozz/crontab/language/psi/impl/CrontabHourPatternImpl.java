...
public abstract class CrontabHourPatternImpl extends CrontabTimePointerImpl implements CrontabHourPattern {

  public CrontabHourPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CrontabVisitor visitor) {
    visitor.visitHourPattern(this);
  }
