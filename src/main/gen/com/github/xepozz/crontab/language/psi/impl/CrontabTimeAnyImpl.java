...
public class CrontabTimeAnyImpl extends ASTWrapperPsiElement implements CrontabTimeAny {

  public CrontabTimeAnyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CrontabVisitor visitor) {
    visitor.visitTimeAny(this);
  }
