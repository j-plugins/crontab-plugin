...
public class CrontabTimePeriodicImpl extends ASTWrapperPsiElement implements CrontabTimePeriodic {

  public CrontabTimePeriodicImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CrontabVisitor visitor) {
    visitor.visitTimePeriodic(this);
  }
