...
public class CrontabTimeListImpl extends ASTWrapperPsiElement implements CrontabTimeList {

  public CrontabTimeListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CrontabTimeListItem> getTimeListItemList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CrontabTimeListItem.class);
  }
