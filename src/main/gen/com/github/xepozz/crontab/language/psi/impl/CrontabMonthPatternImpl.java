...
public abstract class CrontabMonthPatternImpl extends CrontabTimePointerImpl implements CrontabMonthPattern {

  public CrontabMonthPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CrontabVisitor visitor) {
    visitor.visitMonthPattern(this);
  }
