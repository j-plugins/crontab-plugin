...
public abstract class CrontabMinutePatternImpl extends CrontabTimePointerImpl implements CrontabMinutePattern {

  public CrontabMinutePatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CrontabVisitor visitor) {
    visitor.visitMinutePattern(this);
  }
