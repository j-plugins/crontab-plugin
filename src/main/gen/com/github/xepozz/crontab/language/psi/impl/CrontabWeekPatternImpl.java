...
public abstract class CrontabWeekPatternImpl extends CrontabTimePointerImpl implements CrontabWeekPattern {

  public CrontabWeekPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CrontabVisitor visitor) {
    visitor.visitWeekPattern(this);
  }
