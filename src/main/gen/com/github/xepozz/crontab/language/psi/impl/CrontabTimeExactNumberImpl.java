...
public class CrontabTimeExactNumberImpl extends ASTWrapperPsiElement implements CrontabTimeExactNumber {

  public CrontabTimeExactNumberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CrontabVisitor visitor) {
    visitor.visitTimeExactNumber(this);
  }
