package com.github.xepozz.crontab.ide.editor
...
private const val PROMO_RATE = "cron.promo.rate"
...
class EditorNotificationProvider : EditorNotificationProvider, DumbAware {
    override fun collectNotificationData(
        ...
        if (file.fileType !is CrontabFileType) return null
        ...
        return Function { editor ->
            ...
            panel.text = "Cron & Crontab: Rate plugin on the Marketplace, help it grow"
            panel.createActionLabel("Leave Review") {
                BrowserUtil.browse("https://plugins.jetbrains.com/plugin/26412-cron--crontab-support/reviews/new")
